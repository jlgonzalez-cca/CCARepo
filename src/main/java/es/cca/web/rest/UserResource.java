...
import es.cca.repository.search.UserSearchRepository;
import es.cca.security.AuthoritiesConstants;
import es.cca.service.MailService;
import es.cca.service.UserService;
import es.cca.service.dto.UserDTO;
import es.cca.web.rest.errors.BadRequestAlertException;
import es.cca.web.rest.errors.EmailAlreadyUsedException;
import es.cca.web.rest.errors.LoginAlreadyUsedException;
