...
import static es.cca.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import es.cca.TCuApp;
import es.cca.config.Constants;
import es.cca.domain.Authority;
import es.cca.domain.User;
import es.cca.repository.AuthorityRepository;
import es.cca.repository.UserRepository;
import es.cca.security.AuthoritiesConstants;
import es.cca.service.UserService;
import es.cca.service.dto.PasswordChangeDTO;
import es.cca.service.dto.UserDTO;
import es.cca.web.rest.vm.KeyAndPasswordVM;
import es.cca.web.rest.vm.ManagedUserVM;
